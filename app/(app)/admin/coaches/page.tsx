...
const TLP_COACHES = COACHES.filter((c) => c.ownershipId === "ten_tlp");
...
export default function CoachesPage() {
  ...
  const allCoaches = [...TLP_COACHES, ...extraCoaches];
  ...
  return (
    <div style={{ padding: 24 }}>
      <PageHeader
        title="Coaches"
        subtitle="The Learning Planet — coach management"
        actions={
      ...
      <Card style={{ overflow: "hidden", padding: 0 }}>
        ...
        {allCoaches.map((coach, i) => {
          ...
          const assignedBatches = BATCHES.filter((b) => b.coachId === coach.id);
            ...
            <div key={coach.id}>
              ...
              >
                <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                  <Avatar name={coach.fullName} size={36} color={TLP.teal} />
                  <div>
                  ...
                  <div>
                    ...
                    >
                      {coach.status === "on_leave" ? (
                        <div style={{ color: TLP.amber, fontWeight: 600 }}>
                          ⚠️ Currently on medical leave (May 4–7, 2026)
                        </div>
                      ) : (
                        <div style={{ color: TLP.green, fontWeight: 600 }}>✓ Available — Mon–Sat, 4–8pm</div>
                      )}
                      <div style={{ marginTop: 8, color: TLP.gray500 }}>
                        Phone: {coach.phone ?? "—"}
                      </div>
                    </div>
                  </div>
